...
for name in file_names:
  ...
  df=read_root(file)
  df['BDT']=BDTlist[name]
  df.to_root("/data/lhcb/users/hill/Bd2DstTauNu_Angular/RapidSim_tuples/Merged_Bkg/"+name+"_BDT.root")
dg=  read_root("/home/ke/tmps/signal.root")
dg['BDT']=BDTlist['signal']
dg.to_root("/data/lhcb/users/hill/Bd2DstTauNu_Angular/RapidSim_tuples/Bd2DstTauNu/3pi_LHCb_Total/model_vars_weights_hammer_BDT.root")
