...
if __name__ == "__main__" :
  ...
  for b in branch_names:
    ...
    if(toy=="N"):
      fig.savefig('/home/ke/TensorFlowAnalysis/BinnedFigs/%s_%s_%s_%s_%s_Hammer_%s.pdf' % (b,sub_mode,geom,var_type,num_sig,ham))
  ...
  plt.show()
  if(toy=="N"):
    fig.savefig('/home/ke/TensorFlowAnalysis/BinnedFigs/Fit_Lifetime_%s_%s_%s_%s_Hammer_%s.pdf' % (sub_mode,geom,var_type,num_sig,ham))
  ...
  plt.show()
  if(toy=="N"):
    fig.savefig('/home/ke/TensorFlowAnalysis/BinnedFigs/Pull_Lifetime_%s_%s_%s_%s_Hammer_%s.pdf' % (sub_mode,geom,var_type,num_sig,ham))
  ...
  plt.show()
  if(toy=="N"):
    fig.savefig('/home/ke/TensorFlowAnalysis/BinnedFigs/Pull_Hist_Lifetime_%s_%s_%s_%s_Hammer_%s.pdf' % (sub_mode,geom,var_type,num_sig,ham))
